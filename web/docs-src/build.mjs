...
async function writeStaticSitemap() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?>\n` +
    `<!-- Fallback only. The live sitemap is generated per request and also lists\n` +
    `     proof pages and token pages. Regenerated by web/docs-src/build.mjs. -->\n` +
    `<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n` +
    rows.map((r) =>
      `  <url><loc>${SITE}${r.path}</loc><lastmod>${today}</lastmod>` +
